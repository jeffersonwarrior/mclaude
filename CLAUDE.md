...
Mclaude is a modern TypeScript/Node.js interactive CLI tool that integrates Synthetic AI models with Claude Code. It provides model selection, configuration management, and seamless launching of Claude Code with various language models through synthetic endpoints.
...
3. **Manual Update Flow**: Users update via `npm update -g mclaude` (standard npm package management)

### Configuration Architecture

- **Config Storage**: `~/.config/mclaude/config.json`
- **Cache Storage**: `~/.config/mclaude/models_cache.json`
...
2. **Package install**: `npm install -g mclaude`
