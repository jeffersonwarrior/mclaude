...
exports.AppConfigSchema = zod_1.z.object({
    ...
    tokenUsage: zod_1.z
        .object({
        totalInputTokens: zod_1.z
            .number()
            .default(0)
            .describe("Total input tokens used"),
        totalOutputTokens: zod_1.z
            .number()
            .default(0)
            .describe("Total output tokens used"),
        sessionTokens: zod_1.z
            .number()
            .default(0)
...
var ConfigValidationError = /** @class */ (function (_super) {
    ...
    function ConfigValidationError(message, cause) {
...
var ConfigLoadError = /** @class */ (function (_super) {
    __extends(ConfigLoadError, _super);
    function ConfigLoadError(message, cause) {
        var _this = _super.call(this, message) || this;
        _this.cause = cause;
        _this.name = "ConfigLoadError";
        return _this;
    }
    return ConfigLoadError;
}(Error));
exports.ConfigLoadError = ConfigLoadError;
var ConfigSaveError = /** @class */ (function (_super) {
    __extends(ConfigSaveError, _super);
    function ConfigSaveError(message, cause) {
        var _this = _super.call(this, message) || this;
        _this.cause = cause;
        _this.name = "ConfigSaveError";
        return _this;
    }
