...
class TensorZeroProxy {
    ...
    constructor(configManager) {
        ...
        this.modelManager = new manager_1.ModelManager({
            configManager,
            cacheFile: (0, path_1.join)(process.cwd(), ".mclaude", "models-cache.json"),
...
`;
    ...
    async waitForServer(host, port, timeout) {
...
exports.TensorZeroProxy = TensorZeroProxy;
//# sourceMappingURL=tensorzero-proxy.js.map